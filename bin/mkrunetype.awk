...
function otheris() {
	print HEADER_OTHER > "src/isalnumrune.c";
	print "int\nisalnumrune(Rune r)\n{\n\treturn isalpharune(r) || isdigitrune(r);\n}" > "src/isalnumrune.c";
	print HEADER_OTHER > "src/isblankrune.c";
	print "int\nisblankrune(Rune r)\n{\n\treturn r == ' ' || r == '\\t';\n}" > "src/isblankrune.c";
	print HEADER_OTHER > "src/isprintrune.c";
	print "int\nisprintrune(Rune r)\n{\n\treturn !iscntrlrune(r) && (r != 0x2028) && (r != 0x2029) &&" > "src/isprintrune.c";
	print "\t       ((r < 0xFFF9) || (r > 0xFFFB));\n}" > "src/isprintrune.c";
	print HEADER_OTHER > "src/isgraphrune.c";
	print "int\nisgraphrune(Rune r)\n{\n\treturn !isspacerune(r) && isprintrune(r);\n}" > "src/isgraphrune.c";
	print HEADER_OTHER > "src/ispunctrune.c";
	print "int\nispunctrune(Rune r)\n{\n\treturn isgraphrune(r) && !isalnumrune(r);\n}" > "src/ispunctrune.c";
	print HEADER_OTHER > "src/isxdigitrune.c";
